...
export const featuredProjects = [
  ...
  },
  {
    ...
    summary: "An immutable CRUD dashboard and gated membership portal designed to empower trust providers with secure data handling, automated compliance, and frictionless trustee verification.",
  },
  {
    num: "03",
    slug: "the-haze-club",
...
export const allProjects = [
  {
    ...
    category: "Product Design",
    desc: "Product Design & Design System",
    year: "2025",
    image: "/images/work/hero/simpleplek.png",
    summary: "A trust-first ecosystem designed to protect guest data and property access in South Africa's high-stakes short-term rental market, ensuring user delight under strict compliance.",
    quote: "We transformed a standard event calendar into an intelligent membership model, seamlessly pairing curated packages with each property.",
  ...
  },
  {
    ...
    quote: "We engineered a multi-tenant solution gated by custom entitlements tied directly to subscription tiers.",
    results: ["340%", "User engagement increase", "52%", "Churn reduction"],
  },
  {
    num: "03",
