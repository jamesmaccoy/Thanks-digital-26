...
`
    },
    {
      ...
      paragraphs: [
        ...
        "|_ 📁 app", "| |_ 📁 api", "| | |_ 📁 bookings","| | | |_ 📄 route.ts","| | |_ 📁 estimates","| | | |_ 📄 route.ts","| | | |_ 📁 accept-invite","| | | | |_ 📄 route.ts","| |_ 📁 components","| | |_ 📄 CalendarPicker.tsx","| | |_ 📄 SmartEstimateBlock.tsx\n| | |_ 📁 ui","| | | |_ 📄 card.tsx","| | | |_ 📄 calendar.tsx","|_ 📁 lib","| |_ 📄 firebase.ts"
      ]
    }
  ],
  takeaways: [
