...
import { heroStats } from "@/components/pricing/pricingData";
    ...
    >
      <div className="grid gap-10 lg:grid-cols-[1.3fr_0.9fr] lg:items-end">
        <div>
          ...
          <div className="space-y-1 md:space-y-0">
            <h1 className="text-[17vw] md:text-[13vw] lg:text-[8.8vw] leading-none font-bold uppercase tracking-[-0.06em] price-hero-text clip-text">
              <span className="block translate-y-[100%]">Built</span>
            </h1>
            <h1 className="text-[17vw] md:text-[13vw] lg:text-[8.8vw] leading-none font-bold uppercase tracking-[-0.06em] text-textGray price-hero-text clip-text">
              <span className="block translate-y-[100%]">To</span>
            </h1>
            <h1 className="text-[17vw] md:text-[13vw] lg:text-[8.8vw] leading-none font-bold uppercase tracking-[-0.06em] price-hero-text clip-text">
              <span className="block translate-y-[100%]">Scale</span>
            </h1>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-14 lg:mt-20">
        {heroStats.map((stat) => (
          <div
            key={stat.label}
            className="price-hero-card opacity-0 translate-y-8 rounded-2xl border border-[#222] bg-[#0a0a0a] p-5 lg:p-6"
          >
